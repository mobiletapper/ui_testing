...
do
	...
	do
		function Library:NewPicker(name, default, defaultalpha, parent, count, flag, callback)
			...
			local function update()
				...
				TweenService:Create(TextButton, TweenInfo.new(0.06, Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.fromHSV(hue, 1, 1)}):Play()
				TweenService:Create(HueAccent, TweenInfo.new(0.06, Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.fromHSV(hue, 1, 1)}):Play()
				TweenService:Create(Icon, TweenInfo.new(0.06, Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {BackgroundColor3 = hsv}):Play()
				TweenService:Create(SquareAccent, TweenInfo.new(0.06, Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {BackgroundColor3 = hsv}):Play()
			...
			local function set(color, a)
				...
				if hsv ~= oldcolor then
					...
					TweenService:Create(HueAccent, TweenInfo.new(0.06, Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {BackgroundColor3 = Color3.fromHSV(hue, 1, 1)}):Play()
					TweenService:Create(SquareAccent, TweenInfo.new(0.06, Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {BackgroundColor3 = hsv}):Play()
					TweenService:Create(HueSlide, TweenInfo.new(0.03, Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {Position = UDim2.new(0,-2,math.clamp(hue, 0.005, 0.990),0)}):Play()
					TweenService:Create(HueSlide, TweenInfo.new(0.03, Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {Position = UDim2.new(math.clamp(1 - sat, 0.000, 1 - 0.030), 0, math.clamp(1 - val, 0.000, 1 - 0.030), 0)}):Play()
	...
	function Library:Notification(props)
		...
		Value.Name = "Value"
		Value.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
	...
	do
		...
		function Library:Window(Options)
			local Window = {
				...
				Name = Options.Name or 'pasted.<font color="rgb(77,125,255)">solutions</font>';
			};
			--
			...
			function Window:KeyList() -- finobe wanted me to paste off eclipse incase this ever gets leaked LOL
				...
				function NKeyList:NewKey(Name,Page)
					...
					NewKey.Name = "NewKey"
					NewKey.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
		...
		function Library:Page(Properties)
			...
			TextLabel.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
			...
			function Page:Turn(bool)
				if not Library.Cooldown then
					...
					task.spawn(function()
						...
						TweenService:Create(Page.Window.Elements.FadeThing, TweenInfo.new(0.25,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {BackgroundTransparency = 0}):Play()
						task.wait(0.1)
						RealPage.Visible = Page.Open
						TweenService:Create(Page.Window.Elements.FadeThing, TweenInfo.new(0.25,Enum.EasingStyle.Quad,Enum.EasingDirection.InOut), {BackgroundTransparency = 1}):Play()
						task.wait(0.1)
		...
		function Sections:Toggle(Properties)
			...
			function Toggle:Keybind(Properties)
				...
				Hold.ZIndex = 2
				Hold.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
				Hold.Text = "Hold"
				...
				Toggle.ZIndex = 2
				Toggle.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
				Toggle.Text = "Toggle"
				...
				Always.ZIndex = 2
				Always.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
				Always.Text = "Always"
		...
		function Sections:List(Properties)
			...
			local function createoptions(tbl)
				for _, option in next, tbl do
					...
					Disabled.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
					...
					Enabled.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
					Enabled.Text = option
		...
		function Pages:PlayerList(Properties)
			...
			FriendLabel.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
			...
			Priority.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
			Priority.Text = ""
			...
			PriorityLabel.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
			...
			PlayerName1.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
			...
			SectionName.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
			...
			TeamLabel.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
			TeamLabel.Text = "Team"
			...
			NameLabel.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
			NameLabel.Text = "Name"
			...
			StatusLabel.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
			...
			local function createoptions(tbl)
				for i, option in next, tbl do
					if option ~= game.Players.LocalPlayer then
						...
						PlayerName.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
						...
						PlayerStatus.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
						...
						PlayerAccent.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
						...
						PlayerTeam.FontFace = Font.new([[rbxasset://fonts/families/RobotoMono.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);

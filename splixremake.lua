...
do
	...
	do
		...
		function Library:Page(Properties)
			...
			PageName.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
		...
		function Sections:Toggle(Properties)
			...
			function Toggle:Keybind(Properties)
				...
				Hold.ZIndex = 2
				Hold.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
				Hold.Text = "Hold"
				...
				Toggle.ZIndex = 2
				Toggle.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
				Toggle.Text = "Toggle"
				...
				Always.ZIndex = 2
				Always.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
				Always.Text = "Always"
		...
		function Sections:List(Properties)
			...
			Icon.Name = "Icon"
			Icon.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
			Icon.Text = "+"
			...
			local function createoptions(tbl)
				for _, option in next, tbl do
					...
					OptionLabel.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
		...
		function Sections:Button(Properties)
			...
			function Button:Button(Properties)
				...
				iValue.Name = "Value"
				iValue.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
		...
		function Pages:PlayerList(Properties)
			...
			SectionName.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
			...
			PlayerName1.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
			...
			PriorityLabel.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
			...
			FriendLabel.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
			...
			local function createoptions(tbl)
				for i, option in next, tbl do
					...
					PlayerName.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
					...
					PlayerStatus.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
		...
		function Library:Indicator(Properties)
			...
			function Indicator:NewValue(Properties)
				...
				IndValue.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
				IndValue.Text = NewIndicator.Value
				IndValue.TextColor3 = Color3.fromRGB(255, 255, 255)
				IndValue.TextSize = 14
			...
			function Indicator:NewBar(Properties)
				...
				Title1.Name = "Title"
				Title1.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
				...
				IndValue1.FontFace = Font.new("rbxasset://fonts/families/RobotoMono.json")
				IndValue1.Text = "0"
				IndValue1.TextColor3 = Color3.fromRGB(255, 255, 255)
				IndValue1.TextSize = 14
